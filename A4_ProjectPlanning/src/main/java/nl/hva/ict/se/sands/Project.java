...
public class Project implements Comparable<Project> {
     ...
     * excluding weekend days
     * @return collection of dates of available working days
     */
     ...
     * @param employee the employee with the commitment
     * @param hoursPerDay hours added to the commitment
     */
     ...
     * @return total manpower budget
     */
    public int calculateManpowerBudget() {
        return committedHoursPerDay.entrySet().stream().mapToInt(entry -> entry.getKey().getHourlyWage() * entry.getValue()).sum() * getNumWorkingDays();
    }
